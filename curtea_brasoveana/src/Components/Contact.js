    ...
    return (
        <div className="contact-container">
            <div className="Date de contact">
                ...
                <a href={"tel:" + phonenumber}><p>Telefon:+4 0268.472.336</p></a>
                <a href={"tel:" + mobilephone}><p>Mobil:+4 0735.472.336</p></a>
                <p>Email us at <a href={"mailto:" + email1}>office@curteabrasoveana.ro</a></p>
                <p>Email us at <a href={"mailto:" + email2}>curteabrasoveana@gmail.com</a></p>
