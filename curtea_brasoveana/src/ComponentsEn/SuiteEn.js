...
import camera4 from '../assets/suite/suite4.jpg';
import camera5 from '../assets/suite/suite5.jpg';
    ...
    <div className="room_page_container">
      ...
      <div className="room_details">
        ...
        <div className="room_description">
          ...
          <p className = "text"><FontAwesomeIcon icon={faBed} /> 2 matrimonial beds 2x1.6m</p>
          <p className = "text"><FontAwesomeIcon icon={faExpand} /> Room area between 50 and 70sqm</p>
